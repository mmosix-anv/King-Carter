  ...
  return (
    <div className={styles.section}>
      <div className={styles.content}>
        ...
        <p>...with the Quintessentially members' portal. Available on web and as an app, this is where you can seek inspiration for a luxury lifestyle at your leisure. Every feature has been thoughtfully designed to help you make the most of your membership.</p>
